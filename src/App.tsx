...
import { Sun, Moon, AddSquare, ListArrowDown, CheckCircle, ClipboardList } from '@solar-icons/react';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg-main)' }}>
      <div className="max-w-xl mx-auto px-4 py-8 pb-28 sm:py-12">
        ...
        <header className="flex items-start justify-between mb-8">
          <div>
            ...
            {/* Logo — белые пути, нужен фильтр для светлой темы */}
            <div
              className="h-9"
          ...
          <button
            onClick={toggle}
            className="mt-1 w-9 h-9 flex items-center justify-center rounded-2xl border transition-all active:scale-90 hover:scale-105"
